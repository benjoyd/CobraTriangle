 ...
 * Define menus.
 *
 * Create hardcoded menus and map them to a theme region through $ct->config['theme'].
 */
$ct->config['menus'] = array(
  'navbar' => array(
 ...
 * Template files can reside in the parent or current theme, the CCobraTriangle::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly COBRATRIANGLE_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
