...
<tbody>
  <tr><td>Part of CobraTriangle Core modules</td><td><?=$module['isCobraTriangleCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of CobraTriangle CMF modules</td><td><?=$module['isCobraTriangleCMF']?'Yes':'No'?></td></tr>
