<?php
/**
 * A model for managing CobraTriangle modules.
 * 
...
class CMModules extends CObject {
   ...
   * Properties
   */
  private $cobratriangleCoreModules = array('CCobraTriangle', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $cobratriangleCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  public function ReadAndAnalyse() {
    $src = COBRATRIANGLE_INSTALL_PATH.'/src';
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isCobraTriangleCore']   = in_array($rc->name, $this->cobratriangleCoreModules);
      $details['isCobraTriangleCMF']    = in_array($rc->name, $this->cobratriangleCMFModules);
